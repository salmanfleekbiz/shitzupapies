...
<td><?php echo $slider['fullname']; ?></td>
<td ><?php echo $slider['email']; ?></td>
<td ><?php echo $slider['message']; ?></td>
<td ><?php echo $slider['phone']; ?></td>
<td style="width:18%;text-align:center;" ><a href="<?php  echo base_url(); ?>admin_slider/deletslide/<?php echo $slider['id']; ?>" class="btn red">Delete</a></td>
</tr>
<?php } ?>
</tbody>
</table>
